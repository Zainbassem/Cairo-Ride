...
void reading_process() {
    ...
    ifstream globals("D:/Globals_File.txt", ios::in);
    if (!globals.is_open()) {
    ...
    ifstream stations("D:/Stations_File.txt", ios::in);
    if (!stations.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
    ...
    ifstream users_data("D:/User_File.txt", ios::in);
    ...
    ifstream subscriptions("D:/Subscription_File.txt", ios::in);
    ...
    ifstream rides("D:/Ride_File.txt", ios::in);
    if (!rides.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
...
void writing_process() {
    ...
    ofstream globals("D:/Globals_File.txt", ios::out);
    if (!globals.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
    ...
    ofstream stations("D:/Stations_File.txt", ios::out);
    if (!stations.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
    ...
    ofstream users_data("D:/User_File.txt", ios::out);
    if (!users_data.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
    ...
    // Saving updates of users:-
    ofstream subscriptions("D:/Subscription_File.txt", ios::out);
    if (!subscriptions.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
    ...
    ofstream rides("D:/Ride_File.txt", ios::out);
    if (!rides.is_open()) {
        cout << "File was not opened successfully." << endl;
        return;
    }
